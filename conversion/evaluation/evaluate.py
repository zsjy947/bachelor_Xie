...
def calc_scores(dict_gt, dict_pred, out_path, label_path):
    ...
    for task_name in scores.keys():
        ...
        if task_name in ["CMeEE-V2", "CMeIE-V2", "CHIP-CDN", "CMedCausal",
            ...
            try:
                precision, recall, f1,f1_o = calc_info_extract_task_scores(
                    gts,
                    preds
                )
                scores[task_name] = {
...
if __name__ == "__main__":
    ...
    #CMeEE-V2等标签生成文件
    label_path = input_params["fileData"]["outFilePath"]
    ...
    if success_flag:
        try:
            ...
            score_map, success_flag = calc_scores(
                dict_gt, dict_pred, out_path, label_path
            )
